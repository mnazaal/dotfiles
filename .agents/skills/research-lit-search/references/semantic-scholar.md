<!-- Adapted from K-Dense-AI/scientific-agent-skills, skills/paper-lookup/references/semantic-scholar.md (MIT). Endpoints, parameters, pagination and failure modes only; verify a figure against the live API before relying on it. -->
