<!-- Adapted from K-Dense-AI/scientific-agent-skills, skills/paper-lookup/references/opencitations.md (MIT). Endpoints, parameters, pagination and failure modes only; verify a figure against the live API before relying on it. -->
